...
import '../../const/filters.dart';
import '../../controller/controller.dart';
import '../../models/stroke.dart';
import '../../utils/utils.dart';
import '../../widgets/draggable_sticker_widget.dart';
...
class _TopViewState extends State<TopView> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: EdgeInsets.symmetric(horizontal: 15, vertical: Platform.isIOS ? 60 : 40),
      // Padding adjusted for platform differences.
      child: Row(
